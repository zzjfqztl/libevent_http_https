...
//会话开始
static void
sessionBegin (struct evhttp_request *req, void *arg)
{ 
    struct evbuffer *evb = NULL;
    const char *uri = evhttp_request_get_uri (req);
    struct evhttp_uri *decoded = NULL;
...
//会话告警
static void
sessionWarn (struct evhttp_request *req, void *arg)
{ 
    struct evbuffer *evb = NULL;
    const char *uri = evhttp_request_get_uri (req);
    struct evhttp_uri *decoded = NULL;
...
//会话结束
static void
sessionEnd (struct evhttp_request *req, void *arg)
{ 
    struct evbuffer *evb = NULL;
    const char *uri = evhttp_request_get_uri (req);
    struct evhttp_uri *decoded = NULL;
    ...
    */
    ...
    cJSON* time = cJSON_GetObjectItem(root, "time");
    cJSON* sessionID = cJSON_GetObjectItem(root, "sessionID");
    cJSON* logSize = cJSON_GetObjectItem(root, "logSize");
    cJSON* cmdNum = cJSON_GetObjectItem(root, "cmdNum");
    cJSON* resultNum = cJSON_GetObjectItem(root, "resultNum");
...
{ 
    ...
    */
    ...
    evhttp_set_cb(http, "/rest/atas/sessionWarn.do", sessionWarn, NULL);
    evhttp_set_cb(http, "/rest/atas/sessionBegin.do", sessionBegin, NULL);
    evhttp_set_cb(http, "/rest/atas/sessionWarn.do", sessionWarn, NULL);
    evhttp_set_cb(http, "/rest/atas/sessionEnd.do", sessionEnd, NULL);
